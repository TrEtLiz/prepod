...
*Описание схемы.* Движение снизу вверх показывает увеличение осведомлённости: от отсутствия сформулированного запроса до готовности действовать. Схема служит для **сегментации аудитории**, а не для утверждения, что каждый человек обязательно поднимается по одной ступени за раз. В частности, интерес к игре может возникнуть спонтанно, без длительного поиска и сравнения. [bookey](https://www.bookey.app/book/convert!)
